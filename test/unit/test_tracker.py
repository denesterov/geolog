...
def test_smoke():
    fp = common.Point(45.23930, 19.84120, 100500)
    tr, sd, pd = tracker_test_utils.create_basic_env(fp)

    tr.update(fp, location_is_new=True) # 0.0 m
    tr.update(common.Point(45.24060, 19.84200, 100530)) # 156.0 m
    tr.update(common.Point(45.24122, 19.84237, 100570)) # 74.7 m
    ...
    assert pd.points[0] == common.Point(45.23930, 19.84120, 100500)
    assert pd.points[1] == common.Point(45.24060, 19.84200, 100530)
    assert pd.points[2] == common.Point(45.24122, 19.84237, 100570)
